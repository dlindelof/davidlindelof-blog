...
Four people again attended this second meeting, the purpose of which is to share information among people interested in home and building automation. [As previously](/posts/2008/07/trends-in-smart-buildings-meeting-july-2008/), here are photos of the group's collective memory along with my comments.
...
Someone raised a very interesting question at this point, the gist of which was "What's wrong with Excel files?". I have [ranted against the use of Excel in academia before](/posts/2006/01/tools-that-anyone-can-use/), but to these arguments I would add the following.
